...
# ========================================
# Swap roles: Use test data as "training" data and training data as "test" data
# ========================================
# Now "training data" = old test data
# Now "test data" = old training data
X_train_new = X_test
y_train_new = y_test
X_test_new = X_train
y_test_new = y_train
...
X_train_scaled = scaler_X.fit_transform(X_train_new)
X_test_scaled = scaler_X.transform(X_test_new)
y_train_scaled = scaler_Y.fit_transform(y_train_new.reshape(-1, 1))
y_test_scaled = scaler_Y.transform(y_test_new.reshape(-1, 1))
...
# Hyperparameters lists (unchanged)
look_back_list = [10, 20, 30]
days_to_predict_list = [1]
lstm_units_list = [(128,64)]
dropout_rates = [0.2]
            ...
            for dropout_rate in dropout_rates:
                for lr in learning_rates:
                    for batch_size in batch_sizes:
                        ...
                        # Train the model on what was previously the test data
                        ...
                        # Predict on "test" data (which was previously training data)
                        ...
                        # Predict on all training data (which was previously test data)
                        ...
                        # Plot LSTM predictions vs actual (first day) on Test Data (which was originally training data)
                        plt.figure(figsize=(10,6))
                        ...
                        # Plot LSTM predictions vs actual (first day) on Training Data (originally test data)
                        plt.figure(figsize=(10,6))
